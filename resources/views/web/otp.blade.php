            ...
            <div id="login">
                <div class="m-auto bg-white shadow-sm p-5 rounded-3 text-center col-md-4 mx-auto">
                    ...
                    <form action="" class="text-start pt-4" method="POST">
                        ...
                        <div class="mb-3">
                            <a href="{{ route('re_otp') }}" class="btn btn-success">Qayta jo'natish</a>
                    ...
                    <p class="text-muted mb-0">{{ __('home.ask_register') }} <a href="{{ route('register') }}" class="text-success">{{ __('home.register') }}</a></p>
                </div>
