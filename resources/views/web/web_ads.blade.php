<section class="bg-light py-5 border-bottom">
            ...
            @foreach($news as $n)
                <div class="col">
                    <div class="card h-100 border-0 shadow-sm rounded-3 overflow-hidden video-card-item">
                        ...
                        <div class="card-body">
                            <h6 class="card-title pb-3 fw-bold text-white mb-0">
                                <span class="bg-success badge text-white me-2">NEW</span>
                                {{ $n->title_uz }}
                            </h6>
                        ...
                        <div class="card-footer border-0 bg-white border-top p-3">
                            <div class="d-grid">
                                <a href="{{ route('newsShow', $n->id) }}" class="btn btn-success btn-lg">
    ...
    <div class="text-center mt-3 pb-4">
        <a href="{{route('news')}}" class="btn btn-outline-success btn-lg">{{ __('home.all_ads') }} &nbsp;<i class="bi bi-arrow-right"></i></a>
    </div>
</section>
