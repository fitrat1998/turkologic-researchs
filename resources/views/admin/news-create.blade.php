                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" id="news_form" action="{{ route('admin.news.store') }}" class="card-body row" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="title_tr"  class="form-control" id="title_ru" required value="{{ old('title_tr') }}" placeholder="title_tr">
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <textarea id="text_tr" class="form-control" name="text_tr" rows="4" placeholder="Enter ..."></textarea>
                            </div>
                            <!-- /.card-body -->
