            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="card card-primary row">
                        ...
                        <div class="col-md-12 px-4 py-3">
                            <p class="d-inline h5"><strong> Maqola annotatsiyasi:</strong><br> {{ $article->abstract }}
                            </p>
                        </div>
                        <hr>
                        ...
                        <div class="col-md-12 px-4 py-3 row">
                            <div class="col-md-3">
                                ...
                                <a href="{{ asset('storage/article/'.$article->file) }}" class="btn btn-success"
                                   style="width: 160px" download="{{ $article->file }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal"
                                        data-target="#modal-addComment" style="width: 160px"><i class="fa fa-pen"></i>
                                    Xabar yozish
                                </button>
                            </div>
                            <div class="col-sm-6">
                                <form action="{{route('admin.article.status', $article->id)}}" method="get">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" id="status_select" name="status"
            ...
            <div class="modal-content">
                <form method="POST" action="{{ route('admin.article.comment', $article->id) }}">
                    ...
                    <div class="modal-body form-group">
                        <textarea name="comment" class="form-control" id="comment" required placeholder="Izoh yozish"
